    ...
    "InputDataConfig": [
        {
            ...
            "DataSource": {
                "S3DataSource": {
                    "S3DataType": "S3Prefix",
                    "S3Uri": 's3://ai-dev-sagemaker-objdetect/rego-plate-detection/train/'.format(bucket, prefix),
        ...
        },
        {
            ...
            "DataSource": {
                "S3DataSource": {
                    "S3DataType": "S3Prefix",
                    "S3Uri": 's3://ai-dev-sagemaker-objdetect/rego-plate-detection/validation/'.format(bucket, prefix),
                    "S3DataDistributionType": "FullyReplicated"
                }
            },
            "ContentType": "image/jpeg",
        ...
        },
        {
            ...
            "DataSource": {
                "S3DataSource": {
                    "S3DataType": "S3Prefix",
                    "S3Uri": 's3://ai-dev-sagemaker-objdetect/rego-plate-detection/train_annotation/'.format(bucket, prefix),
                    "S3DataDistributionType": "FullyReplicated"
                }
            },
            "ContentType": "image/jpeg",
        ...
        },
        {
            ...
            "DataSource": {
                "S3DataSource": {
                    "S3DataType": "S3Prefix",
                    "S3Uri": 's3://ai-dev-sagemaker-objdetect/rego-plate-detection/validation_annotation/'.format(bucket, prefix),
                    "S3DataDistributionType": "FullyReplicated"
                }
            },
            "ContentType": "image/jpeg",
